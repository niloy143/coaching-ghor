...
const GoogleFacebookSignIn = () => {
    ...
    return (
        <div className={`${dark ? 'bg-slate-500' : 'bg-slate-100'} shadow-md w-11/12 sm:w-2/3 md:w-1/2 xl:w-1/3 mx-auto flex flex-col gap-2 py-8 mb-12 rounded-lg`}>
            <div className='flex items-center justify-center gap-3 w-1/2 mx-auto border shadow-md px-5 py-2 rounded-md cursor-pointer hover:shadow-none hover:translate-y-0.5 bg-slate-100'>
